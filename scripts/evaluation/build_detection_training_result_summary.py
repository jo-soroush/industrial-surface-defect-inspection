...
DEFAULT_INVENTORY_PATH = (
    REPO_ROOT / "artifacts/models/inventory" / f"track_detection_artifact_inventory__{DEFAULT_RUN_ID}.json"
)
DEFAULT_OUTPUT_PATH = REPO_ROOT / "artifacts/models/analysis" / f"training_result__{DEFAULT_RUN_ID}.json"
